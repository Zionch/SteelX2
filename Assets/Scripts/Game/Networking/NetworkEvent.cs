...
public class NetworkEvent
{
    ...
    public static int ReadEvents(Dictionary<ushort, NetworkEventType> eventTypesIn, int connectionId, ref RawInputStream input, INetworkCallbacks networkConsumer) {
